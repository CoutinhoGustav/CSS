    ...
    <div className="home-page">
      ...
      <div className="content-container">
        ...
        <p>
          ...
          formulário abaixo ou utilize nossos canais de contato direto.
        </p>

        <section id="contact-info" className="mb-4">
          <ul>
            <li>
              <i className="fas fa-map-marker-alt"></i> Endereço: Rua da Saúde,
              123 - Centro, Cidade, Brasil
            </li>
            <li>
              <i className="fas fa-phone"></i> Telefone: (61) 9986-54583
            </li>
            <li>
              <i className="fas fa-envelope"></i> Email:
              contato@consultoriosaude.com.br
            </li>
            <li>
              <i className="fas fa-clock"></i> Segunda a Sexta, das 8h às 18h, e
